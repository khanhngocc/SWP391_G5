            ...
            <div class="container">
                ...
                <div class="col-sm-9">
                    ...
                    <div class="signup-form">
                        <!--sign up form-->
                        <h2>Subject Detailed</h2>
                        <form>
                            Title
                            <input type="text" value="${subject.title}" readonly=""/>
                            Author
                            <input type="text" value="${subject.author_name}" readonly=""/>
                            Status
                            <input type="text" value="${subject.status}" readonly=""/>
                            Price
                            <input type="text" value="${subject.price}" readonly=""/>
                            Sale Price
                            <input type="text" value="${subject.salePrice}" readonly=""/>
                        </form>
